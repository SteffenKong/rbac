...
<div class="admin-content">
    <div class="am-cf am-padding">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">角色添加</strong> / <small>Role Add</small></div>
    </div>
        ...
        <div class="col-sm-12 col-md-8 col-md-pull-4">
            <form class="am-form am-form-horizontal">
                <div class="am-form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="roleName" id="user-name" placeholder="请输入角色名">
                ...
                <div class="am-form-group">
                    ...
                    <div class="col-sm-9">
                    <textarea class="" rows="5" name="description" id="doc-ta-1"></textarea>
                    </div>
                </div>
