...
INSERT INTO `monda_admin`(account,password,nick_name,email,phone,status,role_id,created_at,updated_at) VALUES ('SteffenKong','$2y$10$CKYcOw..M0vQwnEurUi8heyzCFhpinOgYG2NmV/K5LbBx5taVXPRi','孔浩源','3266023724@qq.com','15622903410',1,0,unix_timestamp,unix_timestamp);
...
create table if not exists monda_permission_role(
    ...
    permission_id mediumint unsigned not null commnet '权限id',
    created_at int not null comment '创建时间',
    updated_at int not null comment '修改时间',
    primary key (id),
    index idx_role_id (role_id),
